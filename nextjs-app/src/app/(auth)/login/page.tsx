    ...
    try {
      ...
      if (!response.ok) {
        ...
        try {
          ...
          if (errorBody?.message?.toLowerCase().includes("invalid")) {
      ...
      setStatusMessage("Login successful. Opening your profile…");
  ...
  return (
    <div className={styles.page}>
          ...
          <div className={styles.left}>
            <div>
              ...
              <p className={styles.subtitle}>
                Access your automated job profile and OCR tools.
              </p>
            </div>
      ...
      <footer className={styles.footer}>
        ...
        <p>© 2024 GovtJobSimplified. All rights reserved. Secure 256-bit SSL Encryption.</p>
      </footer>
    </div>
  );
}
